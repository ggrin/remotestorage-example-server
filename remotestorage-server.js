...
module.exports = { 
  tokenStore: helpers.tokenStore,
  dataStore: helpers.dataStore,
  disableLogs: helpers.disableLogs,
  enableLogs: helpers.enableLogs,
  addToken: helpers.addToken,
  createHandler: function(tokenStore, dataStore) {
